        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    difficulte = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    FunctionTemplate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TestCases = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Language = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValue: "python"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Probleme__078036D7C651FF26", x => x.ProbId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__1788CC4C9A3C4F25", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Classeme__63F085FDB34D3832", x => x.ClassementId);
                    table.ForeignKey(
                        name: "FK_classement_User",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentaireId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    probleme = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Commenta__4717D05A161A40CF", x => x.CommentaireId);
                    table.ForeignKey(
                        name: "FK_commentaire_User",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    probleme = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    TestsTotal = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Soumissi__8749F9FFA169F861", x => x.SoumissionId);
                    table.ForeignKey(
                        name: "FK_sommision_User",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Classeme__1788CC4DB87541A0",
                table: "Classement",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__A9D1053420F85CE3",
                table: "Users",
                column: "Email",
                unique: true,
